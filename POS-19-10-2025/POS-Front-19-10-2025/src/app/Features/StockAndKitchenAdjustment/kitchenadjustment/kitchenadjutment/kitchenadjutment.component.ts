...
@Component({
  selector: "app-kitchenadjutment",
  templateUrl: "./kitchenadjutment.component.html",
  styleUrls: ["./kitchenadjutment.component.scss"]
})
export class KitchenadjutmentComponent extends imp.general implements imp.OnInit {
  [key: string]: any;
  ...
  initializeobjects(): void {
    this.responseobj = {};
    this.service = this.kitchenadjutmentService;
  ...
  initiateData() {
    ...
    this.AccountsList = this.responseobj.AccountsList;
  }
  ...
  fillDetailsBasedOnInventory(inventoryDocumentId) {
      ...
      if (inventory != null) {
        ...
        inventory.POSInventoryDetails.forEach((detail) => {
          let stockadjustmentDetail = {
            ...
            ItemDocumentId: this.stockhelper.getItemDocumentId(detail.ItemId, this.items),
            UnitDocumentId: this.stockhelper.getUnitDocumentId(detail.UnitId, this.units),
            MainUnitDocumentId: this.stockhelper.getUnitDocumentId(detail.MainUnitId, this.units),
            GItemDocumentId: this.stockhelper.getItemDocumentId(detail.GItemId, this.items),
            GUnitDocumentId: this.stockhelper.getUnitDocumentId(detail.GUnitId, this.units),
            AlternativeItemDocumentId: this.stockhelper.getItemDocumentId(detail.AlternativeItemId, this.items)
          };
    ...
    if (!this.disableControlEdit) {
      ...
      if (inventoryDocumentId !== null) {
        ...
        this.kitchenadjutmentService.assignAvailabeQuantyToDetails(this.responseobj).subscribe((res) => {
