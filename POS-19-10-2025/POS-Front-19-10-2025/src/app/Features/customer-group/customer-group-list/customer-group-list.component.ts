...
import { GeneralGrid, CustomerGroupService, HandlingBackMessages, SettingService, LanguageSerService } from "../imports-customer-group";
@Component({
  selector: "app-customer-group-list",
  templateUrl: "./customer-group-list.component.html",
  styleUrls: ["./customer-group-list.component.scss"]
})
export class CustomerGroupListComponent extends GeneralGrid implements OnInit {
  //#region Declartions
  [key: string]: any;
