...
var database_detail_model_1 = require("src/app/core/Models/Authentication/database-detail-model"); // import { isNullOrUndefined } from "@syncfusion/ej2-base";
...
var LoginComponent =
  ...
  (function () {
    ...
    function LoginComponent(
      ...
      errorMessage, // /*private LocalstorgeService:LocalstorgeService,
      ...
      this.document = document; //#endregion
      ...
      this.onBranchInputFocuscombo = function (event) {
        //this.openkeyboard();
        _this.selectedInputBranch = $("#branch_id").attr("id"); //  this.keyboard.setOptions({
    ...
    LoginComponent.prototype.ngOnInit = function () {
      ...
      var hidenButton = footer.classList.add("hidden"); // hidenButton[0].style.display = "none";
      ...
      this.translate.setDefaultLang("en"); //this.changeCssFile();
      //this.checkIfUserExists();
      //   this.getAllBranches();
    };

    LoginComponent.prototype.changeCssFile = function () {
      var langsSet = this.LocalstorgeService.get("langs"); //let langsSet="en";
      ...
      this.LoginSer.CheckIfUserExists().subscribe(function (res) {
        ...
        if (res == true) {
          if (_this.ifExistBranchDefault) {
            ...
            _this.wizard.next(); // this.wizard.next();
          }
    ...
    LoginComponent.prototype.pullFromServer = function () {
      ...
      this.progressBarLoading(); //this.loadingBarService.start();
      ...
      this.LoginSer.PullFromServer(this.databaseDetailobj).subscribe(function (res) {
        ...
        if (res == true) {
          ...
          if (_this.databaseDetailobj.IsWithImages == true) {
            _this.downloadImages();
          } else _this.toastr.success(_this.errorMessage.GlobalMessages(res), "Login"); //this.wizard.navigate.goToStep(3);
        } else {
    ...
    LoginComponent.prototype.ngAfterViewInit = function () {
      $("#preloader-wrap").addClass("loaded"); // this.Keyboardnum = new Keyboard({
    ...
    LoginComponent.prototype.next = function () {
      if (this.hasNextStep) {
        ...
        this.activeStep.onNext.emit(); // nextStep.isDisabled = false;
    ...
    LoginComponent.prototype.previous = function () {
      if (this.hasPrevStep) {
        ...
        this.activeStep.onPrev.emit(); // prevStep.isDisabled = false;
