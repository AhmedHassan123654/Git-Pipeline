(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('stimulsoft-viewer-angular', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/animations'], factory) :
    (global = global || self, factory(global['stimulsoft-viewer-angular'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.ng.common, global.ng.animations));
}(this, (function (exports, core, http, rxjs, operators, common, animations) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var StiHttpClientService = /** @class */ (function () {
        ...
        StiHttpClientService.prototype.post = function (url, data, responseType) {
            ...
            if (responseType === 'json') {
                ...
                // retry(3),
                operators.timeout(reqTimeout), operators.catchError(function (error) {
    ...
    var MouseService = /** @class */ (function () {
        function MouseService() {
            var _this = this;
            this.documetMouseDown = new rxjs.Subject();
            this.documetMouseMove = new rxjs.Subject();
            this.documetMouseUp = new rxjs.Subject();
    ...
    var StimulsoftViewerComponent = /** @class */ (function () {
        function StimulsoftViewerComponent(controller, menuService, model, exportService, formService, api, printService, dashboardService) {
             ...
             */
            this.email = new core.EventEmitter();
            /**
             ...
             */
            this.design = new core.EventEmitter();
            /**
    ...
    var ButtonComponent = /** @class */ (function () {
        function ButtonComponent(model, controller, menuService, tooltipService, helper) {
            ...
            this.closeButtonAction = new core.EventEmitter();
            this.over = false;
            this.showMenu = false;
    ...
    var MenuComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('menuEl')
        ], MenuComponent.prototype, "menuEl", void 0);
        __decorate([
            core.ViewChild('innerContent')
            ...
            core.Component({
                ...
                animations: [
                    animations.trigger('expand', [
                        animations.state('initialDown', animations.style({ transform: 'translateY(-100%)' })),
                        animations.state('initialUp', animations.style({ transform: 'translateY(100%)' })),
                        animations.state('initialLeft', animations.style({ transform: 'translateX(-100%)' })),
                        animations.state('expanded', animations.style({ transform: 'translateY(0) translateX(0)' })),
                        animations.transition('initialUp => expanded', [
                            animations.animate('150ms ease-in-out')
                        ]),
                        animations.transition('initialDown => expanded', [
                            animations.animate('150ms ease-in-out')
                        ]),
                        animations.transition('initialLeft => expanded', [
                            animations.animate('150ms ease-in-out')
                        ]),
                        animations.transition('expanded => initialLeft', [
                            animations.animate('150ms ease-in-out')
                        ])
                    ])
                ]
    ...
    var TooltipComponent = /** @class */ (function () {
        ...
        TooltipComponent = __decorate([
            core.Component({
                ...
                animations: [
                    animations.trigger('expandDown', [
                        animations.state('initial', animations.style({ opacity: 0, display: 'none' })),
                        animations.state('preInitial', animations.style({ opacity: 0, display: 'block' })),
                        animations.state('preInitial2', animations.style({ opacity: 0, display: 'block' })),
                        animations.state('expanded', animations.style({ opacity: 1, display: 'block' })),
                        animations.transition('preInitial => expanded', [
                            animations.animate('300ms 300ms ease-in-out', animations.keyframes([
                                animations.style({ display: 'block', opacity: 0, offset: 0 }),
                                animations.style({ display: 'block', opacity: 1, offset: 1 }),
                            ]))
                        ])
                    ])
                ]
            ...
            core.Component({
                ...
                animations: [
                    animations.trigger('visibility', [
                        animations.state('visible', animations.style({ opacity: 1, display: 'block' })),
                        animations.state('hidden', animations.style({ opacity: 0, display: 'none' })),
                        animations.transition('hidden => visible', [
                            animations.animate('300ms ease-in-out', animations.keyframes([
                                animations.style({ display: 'block', opacity: 0, offset: 0 }),
                                animations.style({ display: 'block', opacity: 1, offset: 1 }),
                            ]))
                        ]),
                        animations.transition('visible => hidden', [
                            animations.animate('300ms ease-in-out', animations.keyframes([
                                animations.style({ display: 'block', opacity: 1, offset: 0 }),
                                animations.style({ display: 'none', opacity: 0, offset: 1 }),
                            ]))
                        ])
                    ])
                ]
            ...
            core.Component({
                ...
                animations: [
                    animations.trigger('state', [
                        animations.state('opened', animations.style({ height: '*' })),
                        animations.state('closed', animations.style({ height: '0px' })),
    ...
    exports.StimulsoftViewerModule = StimulsoftViewerModule;
    exports.ɵa = ModelService;
    exports.ɵb = StiHttpClientService;
    exports.ɵba = ButtonComponent;
    exports.ɵbb = PageComponent;
    exports.ɵbc = ReportPanelComponent;
    exports.ɵbd = ToolbarSeparatorComponent;
    exports.ɵbe = PageControlComponent;
    exports.ɵbf = TextBoxComponent;
    exports.ɵbg = MenuComponent;
    exports.ɵbh = MenuItemComponent;
    exports.ɵbi = TooltipComponent;
    exports.ɵbj = FindPanelComponent;
    exports.ɵbk = TextBlockComponent;
    exports.ɵbl = BookmarksPanelComponent;
    exports.ɵbm = InteractionsPanelComponent;
    exports.ɵbn = FormButtonComponent;
    exports.ɵbo = ParameterComponent;
    exports.ɵbp = ParameterTextBoxComponent;
    exports.ɵbq = CheckboxComponent;
    exports.ɵbr = ParameterCheckboxComponent;
    exports.ɵbs = ParameterButtonComponent;
    exports.ɵbt = ParameterMenuEditListComponent;
    exports.ɵbu = ParameterMenuItemComponent;
    exports.ɵbv = ParameterMenuSeparatorComponent;
    exports.ɵbw = ParameterFindComponent;
    exports.ɵbx = ParameterMenuNotEditListComponent;
    exports.ɵby = ParameterMenuForValueComponent;
    exports.ɵbz = ParameterMenuForRangeComponent;
    exports.ɵc = HelperService;
    exports.ɵca = DatePickerMenuComponent;
    exports.ɵcb = DropDownListComponent;
    exports.ɵcc = VerticalMenuComponent;
    exports.ɵcd = VerticalMenuItemComponent;
    exports.ɵce = DatePickerDayButtonComponent;
    exports.ɵcf = DoubleDatePickerMenuComponent;
    exports.ɵcg = BaseFormComponent;
    exports.ɵch = ExportFormComponent;
    exports.ɵci = GroupPanelComponent;
    exports.ɵcj = RadioButtonComponent;
    exports.ɵck = DropDownListForExportFormComponent;
    exports.ɵcl = DocumentSecurityMenuComponent;
    exports.ɵcm = DigitalSignatureMenuComponent;
    exports.ɵcn = SendEmailFormComponent;
    exports.ɵco = TextAreaComponent;
    exports.ɵcp = DrillDownPanelComponent;
    exports.ɵcq = OpenDialogComponent;
    exports.ɵcr = PasswordFormComponent;
    exports.ɵcs = ErrorMessageFormComponent;
    exports.ɵct = ResourcesPanelComponent;
    exports.ɵcu = ProgressComponent;
    exports.ɵcv = NavigatePanelComponent;
    exports.ɵcw = AboutPanelComponent;
    exports.ɵcx = ToolbarDopComponent;
    exports.ɵcy = CenterTextComponent;
    exports.ɵcz = NotificationFormComponent;
    exports.ɵd = AnimationService;
    exports.ɵda = DashboardsPanelComponent;
    exports.ɵdb = DashboardButtonComponent;
    exports.ɵe = ControllerService;
    exports.ɵf = StylesService;
    exports.ɵg = PageService;
    exports.ɵh = FormService;
    exports.ɵi = MouseService;
    exports.ɵj = MenuService;
    exports.ɵk = FullScreenService;
    exports.ɵl = TooltipService;
    exports.ɵm = FindService;
    exports.ɵn = Md5Service;
    exports.ɵo = InteractionsService;
    exports.ɵp = DrillDownService;
    exports.ɵq = RadioButtonService;
    exports.ɵr = ExportService;
    exports.ɵs = CollectionsService;
    exports.ɵt = MailService;
    exports.ɵu = EditableFieldsService;
    exports.ɵv = PrintService;
    exports.ɵw = ToolbarService;
    exports.ɵx = ApiService;
    exports.ɵy = DashboardService;
    exports.ɵz = ToolbarComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=stimulsoft-viewer-angular.umd.js.map
